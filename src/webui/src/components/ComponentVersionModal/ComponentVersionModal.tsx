...
> = (props) => {
  ...
  return (
    ...
    >
      <section class="flex flex-col gap-4 max-h-[70vh]">
          ...
          <header class="flex items-center gap-3">
            ...
            >
              <Show when={useDefault()}>
                <mark class="w-2.5 h-2.5 rounded-full bg-primary" />
              </Show>
            </figure>
            <figcaption class="flex-1">
              ...
              <p class="text-sm text-muted-foreground">
                ...
                <Show when={resolvedDefault()}>
                  {" "}
                  <code class="font-mono">({resolvedDefault()})</code>
                </Show>
        ...
        <aside class="flex items-center gap-3">
          ...
          <em class="text-sm text-muted-foreground not-italic">
        ...
        {/* Version list */}
        <menu class="flex-1 overflow-y-auto min-h-[200px] max-h-[300px] border border-border rounded-md list-none m-0 p-0">
          <Show
            when={!versions.loading}
            fallback={
              <output class="flex items-center justify-center py-8">
                <Spinner size="md" />
              </output>
            }
          >
            <Show
              ...
              fallback={
                <figure class="flex flex-col items-center justify-center py-8 text-muted-foreground">
                  ...
                  {(version) => (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <mark class="w-2 h-2 rounded-full bg-primary" />
                        </Show>
                      </figure>
                      <data
        ...
        <Show when={(versions()?.total || 0) > limit}>
          <nav class="flex items-center justify-between text-sm">
            <output class="text-muted-foreground">
            ...
            <menu class="flex gap-2 list-none m-0 p-0">
              <li>
                <button
                  type="button"
                  disabled={offset() === 0}
