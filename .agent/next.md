...
**M3.2: Core CLI Commands** -- Polish and extend the CRUD commands:
- Test all commands against a running ldfd server
- Add missing endpoints (roles, forge, branding, langpacks)
...
- M3.1 (CLI Foundation) is complete and merged to main.
